...
report               REPORT,AT(490,1167,7510,9104),PRE(RPT),FONT('MS Serif',8,COLOR:Black,FONT:regular),THOUS
  ...
  CENTER
                       ...
                       END
break1                 BREAK(Customer:StateCode)
                         HEADER,AT(0,0,7510,354)
                           STRING(@s2),AT(63,73,594,240),USE(Customer:StateCode),FONT('MS Serif',14,,FONT:bold+FONT:underline)
                         END
detail                   DETAIL,AT(10,10,7510,250),USE(?detail)
                           STRING(@K#####|-####KB),AT(4771,63),USE(Customer:ZipCode)
                           STRING(@s35),AT(42,63,1917,167),USE(GLOT:CustName)
                           STRING(@P<<<#PB),AT(6688,63,438,167),USE(Customer:Extension),RIGHT
                           STRING(@s25),AT(3271,63,1375,167),USE(Customer:City)
                           STRING(@s20),AT(2052,63,1115,167),USE(Customer:Company)
                           STRING(@P(###) ###-####PB),AT(5729,63,906,167),USE(Customer:PhoneNumber)
                         END
                       END
...
ReturnValue          BYTE,AUTO
  ...
  ThisReport.AddSortOrder(Customer:StateKey)
