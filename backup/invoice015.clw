...
QuickWindow          WINDOW('Update Products'),AT(,,288,130),FONT('MS Sans Serif',8,COLOR:Black),DOUBLE,CENTER, |
  ICON('FLOW04.ICO'),GRAY,IMM,MDI,HLP('~UpdateProducts'),PALETTE(256),SYSTEM
                       ...
                       ENTRY(@s10),AT(70,9,44,10),USE(PRO:ProductSKU),LEFT(1),UPR,MSG('User defined Product Number'), |
  REQ
                       PROMPT('Description:'),AT(7,25),USE(?PRO:Description:Prompt)
                       ENTRY(@s35),AT(70,25,101,10),USE(PRO:Description),LEFT(1),CAP,MSG('Enter Product''s Description'), |
  REQ
                       ...
                       ENTRY(@n-10.2),AT(70,73,35,10),USE(PRO:QuantityInStock),DECIMAL(12),MSG('Enter quantity' & |
  ' of product in stock')
                       ...
                       ENTRY(@n9.2),AT(70,89,35,10),USE(PRO:ReorderQuantity),DECIMAL(12),MSG('Enter product''s' & |
  ' quantity for re-order')
                       PROMPT('Picture File:'),AT(7,105),USE(?PRO:PictureFile:Prompt)
                       ENTRY(@s64),AT(70,105,101,10),USE(PRO:PictureFile),LEFT(1),DISABLE,MSG('Path of graphic file')
