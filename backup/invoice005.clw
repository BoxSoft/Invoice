...
QuickWindow          WINDOW('Update Detail'),AT(,,193,119),FONT('MS Sans Serif',8,COLOR:Black),RESIZE,CENTER,ICON('NOTE14.ICO'), |
  ...
  IMM
                       ...
                       SPIN(@n9.2B),AT(65,48,33,10),USE(DTL:QuantityOrdered),MSG('Quantity of product ordered'),RANGE(1, |
  99999)
                       ...
                       CHECK('Back Ordered'),AT(117,62),USE(DTL:BackOrdered),COLOR(COLOR:Silver),DISABLE,MSG('Product is' & |
  ' on back order')
