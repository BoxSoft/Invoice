...
Report               REPORT,AT(500,4115,7500,5875),PRE(RPT),FONT('MS Sans Serif',10,COLOR:Black,FONT:regular),THOUS
  ...
  CENTER
                         STRING(@s20),AT(1990,448,3375,333),USE(COM:Name),FONT('MS Sans Serif',18,,FONT:bold),CENTER
                         STRING(@s35),AT(1990,781,3375,250),USE(COM:Address),FONT('MS Sans Serif',12,,FONT:bold),CENTER
                         STRING(@s35),AT(1990,1031,3375,250),USE(LOC:CCSZ),FONT('MS Sans Serif',12,,FONT:bold),CENTER
                         STRING(@P(###) ###-####P),AT(1990,1260,3375,250),USE(COM:Phone),FONT('MS Sans Serif',12,,FONT:bold), |
  CENTER
...
detail1                DETAIL,AT(,,,967),USE(?detail1)
                         ...
                         STRING(@n$10.2),AT(6417,240,844,167),USE(DTL:Discount,,?DTL:Discount:2),DECIMAL(250),SUM,TALLY(detail)
  ...
  FONT('MS Sans Serif',10),CENTER
                         ...
                         STRING(@n$10.2),AT(6417,406,844,167),USE(DTL:TaxPaid),DECIMAL(250),SUM,TALLY(detail)
                         ...
                         STRING(@n$14.2),AT(6208,677,1052,208),USE(DTL:TotalCost,,?DTL:TotalCost:2),DECIMAL(250),SUM, |
  TALLY(detail),TRN
                       END
